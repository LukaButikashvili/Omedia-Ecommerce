           ...
           <li class="nav-item dropdown">
             ...
             <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
               ...
               <?php if (isset($_SESSION['username'])) : ?>
                 ...
                 <a class="dropdown-item" href=<?php echo ('/Omedia-Ecommerce/' . "accountSettings/accountSettingsPage.php") ?>>Account settings <img src="./images/icons/manage_accounts_black_24dp.svg" alt=""> </a>
